...
use miniter_audio::mix::{AudioMixError, MixedAudio, mix_project_audio};
...
use miniter_domain::mask::{BlendMode, MaskSource};
    ...
    F: Fn() -> bool,
{
    ...
    let speed_preset = project.export_profile.encode_effort;
    let mut encoder =
