...
> Android save workaround: After saving your project, if the video is not loaded the next you open it, just reimport the videos (that were intially present previously) in tracks, and delete them (to just load the video into cache), which will load the videos in the project too.
