...
> Android save workaround: After saving your project, if the video is not loaded the next you open it, just reimport the videos present in tracks, and delete them (to load the video into cache), which will load the videos in the project too.